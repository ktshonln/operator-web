...
function TicketDetails() {
  ...
  if (!ticketId) return <p>No ticketId found</p>;
      ...
      <div className="w-full">
        ...
        <div className=" flex space-x-20  justify-between">
          ...
          <h1 className="font-bold text-lg w-fit mx-auto mb-7">{ticket.origin} - {ticket.destination}</h1>
            ...
            <p className="font-light"><span className="text-neutral-500 font-normal">Bought: </span> {format(ticket.purchaseTime ?? 0, "d/M/yyyy HH'H'00")}</p>
            <p className="font-light"><span className="text-neutral-500 font-normal">Departure: </span>{format(ticket.departureTime ?? 0, "d/M/yyyy HH'H'00")}</p>
            <p className="font-light"><span className="text-neutral-500 font-normal">Arrival: </span>{format(ticket.arrivalTime ?? 0, "d/M/yyyy HH'H'00")}</p>
            <p><span className="text-neutral-500">Price: </span>{formatMoney(ticket.pricing.totalCharged)} RWF</p>
