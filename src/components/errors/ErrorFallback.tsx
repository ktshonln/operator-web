...
const ErrorFallback = ({ error, resetErrorBoundary }: FallbackProps) => {
    return (
        ...
        <div className=" mt-20 text-center">
            <p className="font-black text-red-500 text-7xl mb-3 w-fit mx-auto"><BiSolidConfused /></p>
            ...
            <button onClick={resetErrorBoundary} className="bg-brand text-white p-2 pl-8 pr-8 rounded-sm text-sm hover:opacity-90 font-semibold cursor-pointer  active:scale-95">Try again</button>
        </div>
    </div>
    )
 }
